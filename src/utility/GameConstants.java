...
public class GameConstants {
	...
	public static class Item {
		...
		public final static int BEER = 12;
		...
		public final static Map<Integer, Integer> powerUpChances = Map.of(CANDY_PINK, 19, CANDY_BLUE, 17, CANDY_YELLOW,
				15, BEER, 13, RING_CYAN, 11, RING_PINK, 9, RING_RED, 7, CROSS_RED, 5, CLOCK, 3, BOMB, 1);
	}
	...
	public static class Player {
		...
		/**
		 * dddddddddd Indical'azione di atterraggio
		 */
	...
	public static class Enemy {
		 ...
		 */
		public static final int BONNIEBO = 1;
		/**
